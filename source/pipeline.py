...
class Pipeline:
    ...
    def run(self, data_path: str) -> None:
        ...
        X_train, X_test, y_train, y_test = prepare_data_split(df, TARGET)
        ...
        metrics: MetricsDict = evaluator.evaluate(lr_model, X_test, y_test)

        # evaluator.save_metrics_to_json(metrics, LR_RESULTS_PATH / JSON_REPORT_NAME)
        ...
        metrics: MetricsDict = evaluator.evaluate(rf_model, X_test, y_test)

        # evaluator.save_metrics_to_json(metrics, RF_RESULTS_PATH / JSON_REPORT_NAME)
